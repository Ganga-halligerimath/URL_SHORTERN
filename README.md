...
JWT Authentication
📂 Project Structure
frontend/ ├── src/ │ ├── components/ │ │ ├── Main.jsx │ │ ├── Dashboard.jsx │ │ └── Login.jsx │ ├── api/ │ │ └── axios.js │ ├── styles/ │ │ ├── Shorten.css │ │ └── Dashboard.css │ └── App.jsx │ backend/ ├── controllers/ ├── routes/ ├── models/ ├── middleware/ └── server.js
